...
Make sure the following are completed before submission:
...
* Deployed website link (using Elastic IP)
* EC2 instance screenshot (from AWS Console) : your userName should be visible.
...
Use the **Elastic IP address** for the public project link.
